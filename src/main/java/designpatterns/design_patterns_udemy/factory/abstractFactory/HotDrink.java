...
class HotDrinkMachine {
    ...
    public HotDrinkMachine() throws Exception {
        ...
        for (AvailableDrink drink : AvailableDrink.values()) {
            ...
            Class<?> factory = Class.forName("designpatterns.udemyDmitry.factory.abstractFactory." + factoryName + "Factory");
        ...
        Set<Class<? extends IHotDrinkFactory>> types =
                new Reflections("designpatterns.udemyDmitry.factory.abstractFactory.") // ""
