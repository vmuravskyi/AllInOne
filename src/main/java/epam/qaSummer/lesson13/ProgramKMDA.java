...
//        List<UserKMDA> users = getUserFromFile("zp-lupen-2019.csv");
//        System.out.println(users);
//        System.out.println(KMDAUtil.getMaxOkdal(users));
        ...
        List<UserKMDA> usersUrl = getUserFromUrl(url);
        System.out.println(usersUrl);


    }

    private static List<UserKMDA> getUserFromUrl(String url) throws IOException {
...
//        BufferedReader br = new BufferedReader(new FileReader(fileName, Charset.forName("WINDOWS-1251")));
    ...
    private static List<UserKMDA> getUserFromFile(String fileName) throws IOException {
        BufferedReader br = new BufferedReader(new FileReader(fileName, Charset.forName("WINDOWS-1251")));
        List<UserKMDA> users = getUserKMDAS(br);
        return users;
    }
