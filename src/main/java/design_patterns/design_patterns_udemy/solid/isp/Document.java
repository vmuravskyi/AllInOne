package design_patterns.design_patterns_udemy.solid.isp;
...
/**
 * The below is a proper way to segregate old.interfaces.
 */
interface Printer {
...
/**
 * Another idea to extend as many as needed old.interfaces to implement only one.
 */
